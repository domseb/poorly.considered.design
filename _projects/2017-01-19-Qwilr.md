...
{% include modules/image-layouts.html url="/assets/projects/qwilr/custom-styles-2.0.jpg" type="wide" description="UI was custom but was inconsistent, space to grow/cramp" %}
...
{% include modules/image-layouts.html url="/assets/projects/qwilr/colour-picker.png" type="wide" description="UI was custom but was inconsistent, space to grow/cramp" %}

{% include modules/image-layouts.html url="/assets/projects/qwilr/style-shortcuts.jpg" type="wide" description="UI was custom but was inconsistent, space to grow/cramp" %}
